...
export class AProposComponent {
  teamMembers = [
    { name: 'Rémi GENTIL', role: 'Proxy Product Owner / Développeur', website: 'https://github.com/', linkedin: 'https://www.linkedin.com/in/remi-gentil/' },
    ...
    { name: 'Théo LAGUE', role: 'Développeur', website: 'https://github.com/', linkedin: 'https://www.linkedin.com/in/th%C3%A9o-lag%C3%BCe-500503268/' },
    ...
    { name: 'Thibault CHIPY', role: 'Développeur', website: 'https://github.com/', linkedin: 'https://www.linkedin.com/in/thibault-chipy/' }
  ];
}
